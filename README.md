...
The Fit For Life site usea a single webhook at checkout/**checkout/wh**. <br>/
![All Products Page](https://github.com/johnosbb/FullStackDeveloper/blob/master/webhookflow.png
